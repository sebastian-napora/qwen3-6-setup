...
pkill -f "qwen_asr_server" 2>/dev/null
pkill -f "qwen-asr" 2>/dev/null
...
fuser -k 11114/tcp 2>/dev/null

# Final sweep: kill any lingering process on our ports.
for port in 11111 11112 11113 11114; do
...
ss -tlnp 2>/dev/null | grep -E '11111|11112|11113|11114' || echo "  (ports are free)"
